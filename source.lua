...
function NeverLose:CreateWindow(Config)
	...
	-- ═══════════════════════════════════════════════════════════════
	-- COLLAPSIBLE TABS (розкривні групи табів)
	-- ═══════════════════════════════════════════════════════════════
	Window.CollapsibleTabs = {};

	function Window:AddCollapsibleTab(Config)
		Config = NeverLose:ProcessParams(Config, {
			Icon = "folder",
			Name = "Group",
			Tabs = {},
		...
		-- === БАТЬКІВСЬКА КНОПКА ===
		local CollapseButton = Instance.new("Frame")
		local UICorner = Instance.new("UICorner")
		local TabIcon = Instance.new("TextLabel")
		local TabContentLabel = Instance.new("TextLabel")
		local ExpandIcon = Instance.new("TextLabel")

		CollapseButton.Name = NeverLose.RandomString();
		CollapseButton.Parent = LeftScrollingFrame
		CollapseButton.BackgroundColor3 = Color3.fromRGB(41, 45, 49)
		CollapseButton.BackgroundTransparency = 0.5
		CollapseButton.BorderColor3 = Color3.fromRGB(0, 0, 0)
		CollapseButton.BorderSizePixel = 0
		CollapseButton.Size = UDim2.new(1, -12, 0, 29)
		CollapseButton.ZIndex = 8
		CollapseButton.ClipsDescendants = true

		UICorner.CornerRadius = UDim.new(0, 6)
		UICorner.Parent = CollapseButton

		TabIcon.Name = NeverLose.RandomString();
		TabIcon.Parent = CollapseButton
		TabIcon.AnchorPoint = Vector2.new(0, 0.5)
		TabIcon.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		TabIcon.BackgroundTransparency = 1.000
		TabIcon.BorderColor3 = Color3.fromRGB(0, 0, 0)
		...
		TabContentLabel.Name = NeverLose.RandomString();
		TabContentLabel.Parent = CollapseButton
		TabContentLabel.AnchorPoint = Vector2.new(0, 0.5)
		TabContentLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		TabContentLabel.BackgroundTransparency = 1.000
		TabContentLabel.BorderColor3 = Color3.fromRGB(0, 0, 0)
		TabContentLabel.BorderSizePixel = 0
		TabContentLabel.Position = UDim2.new(0, 30, 0.5, 0)
		TabContentLabel.Size = UDim2.new(1, -60, 0, 15)
		TabContentLabel.ZIndex = 9
		TabContentLabel.Font = Enum.Font.GothamMedium
		TabContentLabel.Text = Config.Name
		TabContentLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
		...
		ExpandIcon.Name = NeverLose.RandomString();
		ExpandIcon.Parent = CollapseButton
		ExpandIcon.AnchorPoint = Vector2.new(1, 0.5)
		ExpandIcon.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		ExpandIcon.BackgroundTransparency = 1.000
		ExpandIcon.BorderColor3 = Color3.fromRGB(0, 0, 0)
		ExpandIcon.BorderSizePixel = 0
		ExpandIcon.Position = UDim2.new(1, -5, 0.5, 0)
		ExpandIcon.Size = UDim2.new(0, 20, 0, 20)
		ExpandIcon.ZIndex = 9
		ExpandIcon.FontFace = NeverLose.BuiltInBold
		ExpandIcon.Text = "chevron-small-right"
		ExpandIcon.TextColor3 = Color3.fromRGB(223, 223, 223)
		ExpandIcon.TextSize = 14.000
		ExpandIcon.TextWrapped = true

		-- === КОНТЕЙНЕР ДОЧІРНІХ ТАБІВ ===
		local ChildrenContainer = Instance.new("Frame")
		local ChildrenListLayout = Instance.new("UIListLayout")

		ChildrenContainer.Name = NeverLose.RandomString();
		ChildrenContainer.Parent = LeftScrollingFrame
		ChildrenContainer.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		ChildrenContainer.BackgroundTransparency = 1.000
		ChildrenContainer.BorderColor3 = Color3.fromRGB(0, 0, 0)
		ChildrenContainer.BorderSizePixel = 0
		ChildrenContainer.Size = UDim2.new(1, -12, 0, 0)
		ChildrenContainer.ClipsDescendants = true
		ChildrenContainer.ZIndex = 8
		...
		ChildrenListLayout.Padding = UDim.new(0, 2)

		-- === ФУНКЦІЯ РОЗГОРТАННЯ ===
		Collapsible.Toggle = LPH_NO_VIRTUALIZE(function()
			Collapsible.IsOpen = not Collapsible.IsOpen;
			Collapsible.Signal:SetValue(Collapsible.IsOpen);

			if Collapsible.IsOpen then
				NeverLose.PlayAnimate(ExpandIcon, ManualTween, { Rotation = 90 })
				local targetHeight = #Config.Tabs * 31;
				NeverLose.PlayAnimate(ChildrenContainer, SlowyTween, {
					Size = UDim2.new(1, -12, 0, targetHeight)
				})
				NeverLose.PlayAnimate(CollapseButton, SlowyTween, {
					BackgroundTransparency = 0.3
				})
			else
				NeverLose.PlayAnimate(ExpandIcon, ManualTween, { Rotation = 0 })
				NeverLose.PlayAnimate(ChildrenContainer, SlowyTween, {
		...
		-- === СТВОРЕННЯ ДОЧІРНІХ ТАБІВ ===
		for i, childConfig in ipairs(Config.Tabs) do
			local ChildTab = {
				Signal = NeverLose:CreateSignal(false),
			};

			local ChildButton = Instance.new("Frame")
			local ChildUICorner = Instance.new("UICorner")
			local ChildIcon = Instance.new("TextLabel")
			local ChildLabel = Instance.new("TextLabel")
			local ChildLine = Instance.new("Frame")

			ChildButton.Name = NeverLose.RandomString();
			ChildButton.Parent = ChildrenContainer
			ChildButton.BackgroundColor3 = Color3.fromRGB(35, 38, 42)
			ChildButton.BackgroundTransparency = 1
			ChildButton.BorderColor3 = Color3.fromRGB(0, 0, 0)
			ChildButton.BorderSizePixel = 0
			ChildButton.Size = UDim2.new(1, -20, 0, 27)
			ChildButton.ZIndex = 8

			ChildUICorner.CornerRadius = UDim.new(0, 6)
			ChildUICorner.Parent = ChildButton

			ChildLine.Name = NeverLose.RandomString();
			ChildLine.Parent = ChildButton
			ChildLine.BackgroundColor3 = Color3.fromRGB(45, 48, 58)
			ChildLine.BorderColor3 = Color3.fromRGB(0, 0, 0)
			ChildLine.BorderSizePixel = 0
			ChildLine.Position = UDim2.new(0, 8, 0, 0)
			ChildLine.Size = UDim2.new(0, 2, 1, 0)
			ChildLine.ZIndex = 7

			ChildIcon.Name = NeverLose.RandomString();
			ChildIcon.Parent = ChildButton
			ChildIcon.AnchorPoint = Vector2.new(0, 0.5)
			ChildIcon.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			ChildIcon.BackgroundTransparency = 1.000
			ChildIcon.BorderColor3 = Color3.fromRGB(0, 0, 0)
			ChildIcon.BorderSizePixel = 0
			ChildIcon.Position = UDim2.new(0, 18, 0.5, 0)
			ChildIcon.Size = UDim2.new(0, 22, 0, 22)
			ChildIcon.ZIndex = 9
			ChildIcon.FontFace = NeverLose.BuiltInBold
			ChildIcon.Text = childConfig.Icon or "circle"
			ChildIcon.TextColor3 = Color3.fromRGB(252, 252, 252)
			ChildIcon.TextSize = 14.000
			ChildIcon.TextWrapped = true

			ChildLabel.Name = NeverLose.RandomString();
			ChildLabel.Parent = ChildButton
			ChildLabel.AnchorPoint = Vector2.new(0, 0.5)
			ChildLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			ChildLabel.BackgroundTransparency = 1.000
			ChildLabel.BorderColor3 = Color3.fromRGB(0, 0, 0)
			ChildLabel.BorderSizePixel = 0
			ChildLabel.Position = UDim2.new(0, 44, 0.5, 0)
			ChildLabel.Size = UDim2.new(1, -50, 0, 15)
			ChildLabel.ZIndex = 9
			ChildLabel.Font = Enum.Font.GothamMedium
			ChildLabel.Text = childConfig.Name
			ChildLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
			ChildLabel.TextSize = 12.000
			...
			-- Активація дочірнього таба
			ChildTab.SetValue = LPH_NO_VIRTUALIZE(function(value)
				ChildTab.Signal:SetValue(value);

				if value then
					-- Закриваємо інші
					for _, otherTab in ipairs(Collapsible.TabSignals) do
						if otherTab ~= ChildTab then otherTab.SetValue(false); end
					end
					for _, otherCollapsible in ipairs(Window.CollapsibleTabs) do
						if otherCollapsible ~= Collapsible then
							for _, otherChild in ipairs(otherCollapsible.TabSignals) do
								otherChild.SetValue(false);
							end
						end
					end
					for _, regularTab in ipairs(Window.Tabs) do
						regularTab.SetValue(false);
					end

					NeverLose.PlayAnimate(ChildButton, SlowyTween, {
						BackgroundTransparency = 0.3,
						BackgroundColor3 = NeverLose.AccentColor
					})
					NeverLose.PlayAnimate(ChildIcon, SlowyTween, {
						TextTransparency = 0,
						TextColor3 = Color3.fromRGB(255, 255, 255)
					})
					NeverLose.PlayAnimate(ChildLabel, SlowyTween, {
						TextTransparency = 0
					})
					TabFrame.Visible = true;
				else
					NeverLose.PlayAnimate(ChildButton, SlowyTween, {
						BackgroundTransparency = 1,
						BackgroundColor3 = Color3.fromRGB(35, 38, 42)
					})
					NeverLose.PlayAnimate(ChildIcon, SlowyTween, {
						TextTransparency = 0.5,
						TextColor3 = Color3.fromRGB(252, 252, 252)
			...
			-- Клік по дочірньому
			local childInput = NeverLose:CreateInput(ChildButton, LPH_NO_VIRTUALIZE(function()
				ChildTab.SetValue(true);
			end))

			NeverLose:AddSignal(childInput.MouseEnter:Connect(LPH_NO_VIRTUALIZE(function()
				if not ChildTab.Signal:GetValue() then
					NeverLose.PlayAnimate(ChildButton, SlowyTween, { BackgroundTransparency = 0.8 })
				end
			end)))

			NeverLose:AddSignal(childInput.MouseLeave:Connect(LPH_NO_VIRTUALIZE(function()
				if not ChildTab.Signal:GetValue() then
					NeverLose.PlayAnimate(ChildButton, SlowyTween, { BackgroundTransparency = 1 })
				end
			end)))

			-- AddSection для дочірнього таба
			function ChildTab:AddSection(Config)
				Config = NeverLose:ProcessParams(Config, {
					Name = "SECTION",
					Position = 'left'
				});
				...
				local Section = NeverLose:RegisiterItem(SectionHandler, ChildTab.Signal);

				Section.SetRender = LPH_NO_VIRTUALIZE(function(value)
					if value then
						NeverLose.PlayAnimate(SectionLabel, SlowyTween, { TextTransparency = 0.500 })
						NeverLose.PlayAnimate(SectionHandler, SlowyTween, { BackgroundTransparency = 0.500 })
				...
				Section.SetRender(ChildTab.Signal:GetValue());
				ChildTab.Signal:Connect(Section.SetRender);

				return Section;
			end

			table.insert(Collapsible.TabSignals, ChildTab);
		end

		-- Клік по батьківському
		local parentInput = NeverLose:CreateInput(CollapseButton, LPH_NO_VIRTUALIZE(function()
			Collapsible.Toggle();
		end))

		NeverLose:AddSignal(parentInput.MouseEnter:Connect(LPH_NO_VIRTUALIZE(function()
			if not Collapsible.IsOpen then
				NeverLose.PlayAnimate(CollapseButton, SlowyTween, { BackgroundTransparency = 0.4 })
			end
		end)))

		NeverLose:AddSignal(parentInput.MouseLeave:Connect(LPH_NO_VIRTUALIZE(function()
			if not Collapsible.IsOpen then
				NeverLose.PlayAnimate(CollapseButton, SlowyTween, { BackgroundTransparency = 0.5 })
			end
		end)))
		...
		Window.Signal:Connect(LPH_NO_VIRTUALIZE(function(value)
			if value then
				NeverLose.PlayAnimate(TabIcon, SlowyTween, { TextTransparency = 0 })
				NeverLose.PlayAnimate(TabContentLabel, SlowyTween, { TextTransparency = 0 })
				NeverLose.PlayAnimate(ExpandIcon, SlowyTween, { TextTransparency = 0.5 })
			else
				...
				NeverLose.PlayAnimate(ExpandIcon, SlowyTween, { TextTransparency = 1 })
				if Collapsible.IsOpen then Collapsible.Toggle(); end
			end
		end))

		table.insert(Window.CollapsibleTabs, Collapsible);
		return Collapsible;
	end
	-- ═══════════════════════════════════════════════════════════════
	-- КІНЕЦЬ COLLAPSIBLE TABS
	-- ═══════════════════════════════════════════════════════════════
